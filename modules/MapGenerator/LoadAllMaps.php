...
try
{
    ...
    if (!empty($TypeMaps)) {
        if (!empty(GetMaps($TypeMaps))) {
            ...
            echo showError(getTranslatedString('wrong_action'), getTranslatedString('missing_map_list'));
        }

    } else {
        echo showError(getTranslatedString('information'), getTranslatedString('not_map'));
    }
} catch (Exception $ex) {
    ...
    echo showError(getTranslatedString('wrong_action'), "");
}
