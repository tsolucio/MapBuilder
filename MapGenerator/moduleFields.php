...
if (isset($_REQUEST['MapId'])) {
	...
	function getModFields($module, $FieldsArrays = []) {
		...
		$sql .= " group by vtiger_field.fieldid order by block,sequence";
				...
				if ($fieldlabel == "Product Code") {
					...
					foreach ($FieldsArrays as $item) { //$item
						if (strlen($item) != 0 && strpos($item, $fieldcolname) !== false) {
							$checkexist = true;
							//$OPTION_SET .= "<option selected value='" . $fieldtablename . ":" . $fieldcolname . ":" .
							//  $fieldname . "::" . $fieldtypeofdata . "'" . $select_flag . ">" . $mod_fieldlabel . "</option>";
						} else {
							// $checkexist=false;
							//$OPTION_SET .= "<option value='" . $fieldtablename . ":" . $fieldcolname . ":" . $fieldname . "::"
							//  . $fieldtypeofdata . "'" . $select_flag . ">" . $mod_fieldlabel . "</option>";
						}
					}
					if ($checkexist) {
						$OPTION_SET .= "<option selected value='" . $fieldtablename . ":" . $fieldcolname . ":" . $fieldname . "::"
						 . $fieldtypeofdata . "'" . $select_flag . ">" . $mod_fieldlabel . "</option>";
					} else {
						$OPTION_SET .= "<option value='" . $fieldtablename . ":" . $fieldcolname . ":" . $fieldname . "::"
						 . $fieldtypeofdata . "'" . $select_flag . ">" . $mod_fieldlabel . "</option>";
				...
				if ($fieldlabel == "Reports To") {
					...
					foreach ($FieldsArrays as $item) { //$item
						if (strlen($item) != 0 && strpos($item, $fieldcolname) !== false) {
							$checkexist = true;
							//$OPTION_SET .= "<option selected value='" . $fieldtablename . ":" . $fieldcolname . ":" . $fieldname . "::"
							//  . $fieldtypeofdata . "'" . $select_flag . ">" . $mod_fieldlabel . " - " . $mod_strings['LBL_LIST_LAST_NAME'] . "</option>";
						} else {
							// $checkexist=false;
							//   $OPTION_SET .= "<option value='" . $fieldtablename . ":" . $fieldcolname . ":" . $fieldname . "::" . $fieldtypeofdata . "'"
							//  . $select_flag . ">" . $mod_fieldlabel . " - " . $mod_strings['LBL_LIST_LAST_NAME'] . "</option>";
						}
					}
					if ($checkexist) {
						$OPTION_SET .= "<option selected value='" . $fieldtablename . ":" . $fieldcolname . ":" . $fieldname . "::" . $fieldtypeofdata . "'"
						 . $select_flag . ">" . $mod_fieldlabel . " - " . $mod_strings['LBL_LIST_LAST_NAME'] . "</option>";
					} else {
						$OPTION_SET .= "<option value='" . $fieldtablename . ":" . $fieldcolname . ":" . $fieldname . "::" . $fieldtypeofdata . "'"
						 . $select_flag . ">" . $mod_fieldlabel . " - " . $mod_strings['LBL_LIST_LAST_NAME'] . "</option>";
					...
					foreach ($FieldsArrays as $item) { //$item
						...
						if (strlen($item) != 0 && strpos($item, $fieldcolname) !== false) {
							$checkexist = true;
							//$OPTION_SET .= "<option selected value='vtiger_contactdetails:lastname:" . $fieldname . "::" . $fieldtypeofdata . "' "
							//  . $select_flag . ">" . $app_strings['LBL_CONTACT_LAST_NAME'] . "</option>";
							//$OPTION_SET .= "<option selected value='vtiger_contactdetails:firstname:" . $fieldname . "::"
							//  . $fieldtypeofdata . "'>" . $app_strings['LBL_CONTACT_FIRST_NAME'] . "</option>";
						} else {
							// $OPTION_SET .= "<option value='vtiger_contactdetails:lastname:" . $fieldname . "::"
							//  . $fieldtypeofdata . "' " . $select_flag . ">" . $app_strings['LBL_CONTACT_LAST_NAME'] . "</option>";
							// $OPTION_SET .= "<option selected value='vtiger_contactdetails:firstname:" . $fieldname . "::"
							//  . $fieldtypeofdata . "'>" . $app_strings['LBL_CONTACT_FIRST_NAME'] . "</option>";
						}
					}
					if ($checkexist) {
						$OPTION_SET .= "<option selected value='vtiger_contactdetails:lastname:" . $fieldname . "::" . $fieldtypeofdata . "' "
						 . $select_flag . ">" . $app_strings['LBL_CONTACT_LAST_NAME'] . "</option>";
						$OPTION_SET .= "<option selected value='vtiger_contactdetails:firstname:" . $fieldname . "::" . $fieldtypeofdata . "'>"
						 . $app_strings['LBL_CONTACT_FIRST_NAME'] . "</option>";
					} else {
					...
					foreach ($FieldsArrays as $item) { //$item
						if (strlen($item) != 0 && strpos($item, $fieldcolname) !== false) {
							$checkexist = true;
							//$OPTION_SET .= "<option selected value='vtiger_campaign:campaignname:" . $fieldname . "::" . $fieldtypeofdata . "' "
							//  . $select_flag . ">" . $mod_fieldlabel . "</option>";
						} else {
							// $checkexist=false;
							//$OPTION_SET .= "<option   value='vtiger_campaign:campaignname:" . $fieldname . "::" . $fieldtypeofdata . "' "
							//  . $select_flag . ">" . $mod_fieldlabel . "</option>";
						}
					}
					if ($checkexist) {
					...
					foreach ($FieldsArrays as $item) { //$item
						if (strlen($item) != 0 && strpos($item, $fieldcolname) !== false) {
							$checkexist = true;
							//$OPTION_SET .= "<option selected value='" . $fieldtablename . ":" . $fieldcolname . ":" . $fieldname . "::" . $fieldtypeofdata . "' "
							//  . $select_flag . ">" . str_replace("'", "`", $fieldlabel) . "</option>";
						} else {
							// $checkexist=false;
							//$OPTION_SET .= "<option   value='" . $fieldtablename . ":" . $fieldcolname . ":" . $fieldname . "::" . $fieldtypeofdata . "' "
							//  . $select_flag . ">" . str_replace("'", "`", $fieldlabel) . "</option>";
		...
		if ($module == 'Activities') {
			...
			foreach ($FieldsArrays as $item) { //$item
				if (strlen($item) != 0 && strpos($item, $fieldcolname) !== false) {
					$checkexist = true;
					//$OPTION_SET .= "<option selected value=\'vtiger_activity.activitytype:" . $fieldname . "::" . $fieldtypeofdata . "\'>" .
					//  $mod_fieldlabel . "</option>";
				} else {
