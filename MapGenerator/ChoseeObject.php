...
if (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "SQL") {
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "Mapping") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	$smarty->assign("APP", $app_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "MasterDetail") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	$smarty->assign("APP", $app_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "ListColumns") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	$smarty->assign("APP", $app_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "ConditionQuery") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	$output = $smarty->fetch('modules/MapGenerator/createJoinCondition.tpl');
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "Module_Set") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "IOMap") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "FieldDependency") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "FieldDependencyPortal") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "GlobalSearchAutocomplete") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "ConditionExpression") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "CREATEVIEWPORTAL") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "DETAILVIEWBLOCKPORTAL") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "MENUSTRUCTURE") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "RecordAccessControl") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "DuplicateRecords") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "RendicontaConfig") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "ImportBusinessMapping") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "RecordSetMapping") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "ExtendedFieldInformationMapping") {
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	$smarty->assign("MOD", $mod_strings);
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "WS") {
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "WS Validation") {
	$listdtat = CheckIfExistResponseTypeTable(TypeOFErrors::HTTPRESPONSETYPETABLE);
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "RelatedPanes") {
	$listdtat = CheckIfExistResponseTypeTable(TypeOFErrors::HTTPRESPONSETYPETABLE);
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	...
	echo $output;
} elseif (isset($_POST['ObjectType']) && $_POST['ObjectType'] == "FieldSet") {
	$listdtat = CheckIfExistResponseTypeTable(TypeOFErrors::HTTPRESPONSETYPETABLE);
	$queryid = md5(date("Y-m-d H:i:s") . uniqid(rand(), true));
	//echo "<h2>".$MapId."</h2>";
	$smarty = new vtigerCRM_Smarty();
	...
	echo showError(getTranslatedString('error'), getTranslatedString('not_exist_a_map_type') . $_POST['ObjectType']);
}