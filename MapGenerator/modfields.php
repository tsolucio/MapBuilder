 ...
 *************************************************************************************************/
function getModFields($module, $FieldsArrays = [], $uitype = '') {
	...
	global $current_user;
	$checkexist = false;
	global $mod_strings, $app_strings, $OPTION_SET;
		...
		if ($fieldlabel != 'Related to') {
			...
			if ($fieldlabel == "Reports To") {
				...
				if ($checkexist === true) {
					...
					$OPTION_SET .= "<option value='vtiger_contactdetails:lastname:" . $fieldname . "::" . $fieldtypeofdata . "' " .
					 $select_flag . ">" . $app_strings['LBL_CONTACT_LAST_NAME'] . "</option>";
					$OPTION_SET .= "<option value='vtiger_contactdetails:firstname:" . $fieldname . "::" . $fieldtypeofdata . "'>" .
					 $app_strings['LBL_CONTACT_FIRST_NAME'] . "</option>";
				}
				...
				if ($checkexist === true) {
					...
					$OPTION_SET .= "<option value='vtiger_campaign:campaignname:" . $fieldname . "::" . $fieldtypeofdata . "' " . $select_flag . ">" .
